...
SRC=ansi.c basic.c bind.c buffer.c crypt.c display.c eval.c exec.c \
	...
	termio.c vmsvt.c vt52.c window.c names.c globals.c version.c \
...
OBJ=ansi.o basic.o bind.o buffer.o crypt.o display.o eval.o exec.o \
	...
	termio.o vmsvt.o vt52.o window.o names.o globals.o version.o \
...
ifeq ($(findstring CYGWIN,$(uname_S)),CYGWIN)
 DEFINES=-DAUTOCONF -D_BSD_SOURCE -D_SVID_SOURCE -D_XOPEN_SOURCE=600 -D__STRICT_ANSI__ -I/usr/include/ncurses -I/usr/include
endif
